...
conv_llava_llama_3 = Conversation(
    ...
    tokenizer_id="/mnt/workspace/workgroup/jinmu/ckpts/Meta-Llama-3-8B-Instruct",
    tokenizer=AutoTokenizer.from_pretrained("/mnt/workspace/workgroup/jinmu/ckpts/Meta-Llama-3-8B-Instruct"),
